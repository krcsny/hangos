...
var FX, Mic, Mouse, Player, Recorder, Slots, Visual, checkstates, init, setbuttons;
...
checkstates = function() {
  ...
  return $($($("#phone").children()[2]).children()[1]).html(playing ? "&#x25a0;" : "&#x25b6;");
};
...
init = function() {
  var buttons, fx, looper, mainplay, mainrec, master, play, record, s, slots, volumeDown, volumeUp;
  slots = (function() {
    var j, ref, results;
    results = [];
    for (s = j = 0, ref = Slots - 1; (0 <= ref ? j <= ref : j >= ref); s = 0 <= ref ? ++j : --j) {
